...
\subsection*{V. Custom Model Training}

A lightweight custom model was trained for stress phenotyping in young maize leaves, targeting white or grey cold-stress tips (Fig.~XE). Target regions were first segmented and curated in the interactive workflow, and these masks were used to train a binary segmentation model. The trained model focused on stress-tip regions rather than general leaf tissue, enabling task-specific segmentation of cold-stress symptoms. This shows how curated SAM~2-assisted annotations can be distilled into a smaller model for rapid, specialised inference on new images.
